              ...
              <tr>
                <td class="wrapper" style="font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; box-sizing: border-box; padding: 24px;" valign="top">
                  <p>
                    ...
                    Welcome to the Shakewell family! <br><br>

                    To show our appreciation, here’s a special voucher just for you: <strong>{{$voucher}}</strong>. <br>Use it at checkout to enjoy discounts & offers. <br><br>

                    Thank you for joining us. We’re excited to have you on board! <br><br>
